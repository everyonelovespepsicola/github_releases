...
class ThemeConfig {
  ...
  factory ThemeConfig.fromJson(Map<String, dynamic> json) {
    return ThemeConfig(
      ...
      accent: _parseHexColor(json['accent'] as String? ?? '', const Color(0xFF1A1D24)),
      onAccent: _parseHexColor(json['onAccent'] as String? ?? '', const Color(0xFFF8FAFC)),
      accentText: _parseHexColor(json['accentText'] as String? ?? '', const Color(0xFFF8FAFC)),
      accentSecondary: _parseHexColor(json['accentSecondary'] as String? ?? '', const Color(0xFF2A2E3D)),
      onAccentSecondary: _parseHexColor(json['onAccentSecondary'] as String? ?? '', const Color(0xFFF8FAFC)),
  ...
  static const ThemeConfig metroDark = ThemeConfig(
    themeName: 'Metro Dark Monochrome',
    ...
    accent: Color(0xFF1A1D24),
    onAccent: Color(0xFFF8FAFC),
    accentText: Color(0xFFF8FAFC),
    accentSecondary: Color(0xFF2A2E3D),
    onAccentSecondary: Color(0xFFF8FAFC),
